...
router.post("/login", function(req, res, next){
  ...
  // req.body.email = "joao@hcode.com.br";
...
router.get("/reservations/chart", function(req, res, next) {
  ...
  req.query.start = (req.query.start) ? req.query.start : moment().subtract(1, "year").format("YYY-MM-DD");
  req.query.end = (req.query.end) ? req.query.end : moment().format("YYY-MM-DD");
